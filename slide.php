    ...
    <div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 800px; height: 456px; overflow: hidden; visibility: hidden; background-color: #24262e;">
        ...
        <?php include 'dbCon.php';
            ...
            while($r=mysqli_fetch_array($result)){
              ...
              <img data-u="image" src="admin/<?php echo $r['image_path'];?>"/>
              <img data-u="image" src="admin/<?php echo $r['image_path'];?>"/>
            ...
            //echo'<div data-p="144.50" style="display: none;">
              //  <img data-u="image" src="data:image/jpeg;base64,'.base64_encode( $r['image'] ).'" />
                //<img data-u="thumb" src="data:image/jpeg;base64,'.base64_encode( $r['image'] ).'" />
                //</div>';
            }
            ?>
